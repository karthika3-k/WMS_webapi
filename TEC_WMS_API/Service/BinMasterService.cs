    ...
    public class BinMasterService : IBinMaster
    {
        ...
        public async Task<int> CreateBinMasterAsync(List<BinMasterRequest> binMasters)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogLevel = "Error",
                    MethodName = nameof(CreateBinMasterAsync),
                    ModuleID = null,
                    ExceptionMessage = ex.Message, // Custom message
                    Parameters = $"{binMasters}",
        ...
        public async Task<int> CreateBinMasterTempAsync(List<BinMasterRequest> binMasters)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogLevel = "Error",
                    MethodName = nameof(CreateBinMasterTempAsync),
                    ModuleID = null,
                    ExceptionMessage = ex.Message, // Custom message
                    Parameters = $"{binMasters}",
                    StackTrace = string.Empty, // No stack trace here
        ...
        private DataTable ConvertToDataTable(List<BinMasterRequest> binMasters)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogLevel = "Error",
                    MethodName = nameof(ConvertToDataTable),
                    ModuleID = null,
                    ExceptionMessage = ex.Message, // Custom message
                    Parameters = $"{binMasters}",
                    StackTrace = string.Empty, // No stack trace here
        ...
        public async Task<IEnumerable<BinMasterRequest>> GetAllMasterConfigAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogLevel = "Error",
                    MethodName = nameof(GetAllMasterConfigAsync),
                    ModuleID = null,
                    ExceptionMessage = ex.Message, // Custom message
                    Parameters = null,
                    StackTrace = string.Empty, // No stack trace here
        ...
        public async Task<IEnumerable<BinMasterRequest>> GetBinMasterByWhsAsync(string whsCode)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogLevel = "Error",
                    MethodName = nameof(GetBinMasterByWhsAsync),
                    ModuleID = null,
                    ExceptionMessage = ex.Message, // Custom message
                    Parameters = whsCode,
                    StackTrace = string.Empty, // No stack trace here
        ...
        public async Task<IEnumerable<BinMasterRequest>> ValBinMasterDataAsync(string userSign)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogLevel = "Error",
                    MethodName = nameof(ValBinMasterDataAsync),
                    ModuleID = null,
                    ExceptionMessage = ex.Message, // Custom message
                    Parameters = userSign,
                    StackTrace = string.Empty, // No stack trace here
        ...
        public async Task<BinMasterRequest?> GetBinMasterByIdAsync(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogLevel = "Error",
                    MethodName = nameof(GetBinMasterByIdAsync),
                    ModuleID = null,
                    ExceptionMessage = ex.Message, // Custom message
                    Parameters = $"{id}",
                    StackTrace = string.Empty, // No stack trace here
        ...
        public async Task<bool> UpdateBinMasterAsync(int binId, BinMasterRequest binMaster)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogLevel = "Error",
                    MethodName = nameof(UpdateBinMasterAsync),
                    ModuleID = null,
                    ExceptionMessage = ex.Message, // Custom message
                    Parameters = $"{binId}, {binMaster}",
                    StackTrace = string.Empty, // No stack trace here
                    EventTimestamp = DateTime.Now.ToString("yyyy-MM-dd hh:mm:ss tt")
                };
                _databaseConfig.InsertExceptionLogSP(logEntry);
        ...
        public async Task<bool> DeleteBinMasterAsync(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogLevel = "Error",
                    MethodName = nameof(DeleteBinMasterAsync),
                    ModuleID = null,
                    ExceptionMessage = ex.Message, // Custom message
                    Parameters = $"{id}",
                    StackTrace = string.Empty, // No stack trace here
        ...
        public async Task<bool> DeleteBinMasterTempAsync(string userSign)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogLevel = "Error",
                    MethodName = nameof(DeleteBinMasterTempAsync),
                    ModuleID = null,
                    ExceptionMessage = ex.Message, // Custom message
                    Parameters = $"{userSign}",
                    StackTrace = string.Empty, // No stack trace here
